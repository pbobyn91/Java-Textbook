public class PolymorphismTest {
	...
	public static void main (String[] args){
		...
		System.out.printf("%s %s:%n%n%s%n%n", "Call to CommissionEmployee's toString with superclass reference", 
					"to superclass object", commissionEmployee.toString());
					
		System.out.printf("%s %s:%n%n%s%n%n", "Call to BasePlusCommissionEmployee's toString with superclass reference", 
